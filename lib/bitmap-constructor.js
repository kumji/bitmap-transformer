...
var Bitmap = function(buf) {
	this.headerOffset = this.buf.splice(0, 14);
	this.headerDIB = this.buf.splice(14, 40);
	this.width = this.buf.readUint32[18];
	this.height = this.buf.readUint32[22];
	this.pixelArrayStart = this.buf.slice(54, this.header.dataOffset);
	this.binaryData = [];
